    ...
    <div className="h-full flex flex-col gap-6">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          <div className="w-16 h-16 rounded-full bg-zinc-200 flex items-center justify-center text-[22px] text-zinc-600">
            ER
          </div>
          <div>
            <h1 className="text-zinc-900">{firstName} {lastName}</h1>
            <p className="text-[14px] text-zinc-500 mt-0.5">{jobTitle} · {department}</p>
            <div className="flex items-center gap-3 mt-1">
              <span className="text-[11px] px-2 py-0.5 rounded-full bg-violet-100 text-violet-800">Admin</span>
              <span className="text-[11px] px-2 py-0.5 rounded-full bg-emerald-100 text-emerald-800">MFA Enabled</span>
            </div>
          </div>
        </div>
        {tab === 'profile' && (
      ...
      <div className="flex border-b border-zinc-200">
        {tabs.map(t => (
          <button key={t.key} onClick={() => setTab(t.key)}
            ...
            {t.label}
            {t.key === 'sessions' && <span className="ml-1.5 text-[11px] bg-zinc-100 px-1.5 py-0.5 rounded-full">{sessions.length}</span>}
          </button>
        ))}
      </div>
          ...
          <div className="space-y-6">
            <div className="glass-card rounded-2xl overflow-hidden">
              ...
              <div className="p-6 grid grid-cols-2 gap-5">
                <div>
                  <label className="text-[12px] text-zinc-500 mb-1.5 block">First Name</label>
                  <input type="text" value={firstName} onChange={e => setFirstName(e.target.value)}
                    className="w-full px-4 py-2.5 bg-white border border-zinc-200 rounded-lg text-[14px] text-zinc-900 outline-none focus:ring-2 focus:ring-zinc-900/10" />
                </div>
                <div>
                  <label className="text-[12px] text-zinc-500 mb-1.5 block">Last Name</label>
                  <input type="text" value={lastName} onChange={e => setLastName(e.target.value)}
                    className="w-full px-4 py-2.5 bg-white border border-zinc-200 rounded-lg text-[14px] text-zinc-900 outline-none focus:ring-2 focus:ring-zinc-900/10" />
                </div>
                <div>
                  <label className="text-[12px] text-zinc-500 mb-1.5 block">Email</label>
                  <div className="flex items-center gap-2 px-4 py-2.5 bg-zinc-50 border border-zinc-200 rounded-lg">
                    <Email size={14} className="text-zinc-400" />
                    <span className="text-[14px] text-zinc-500">{emailAddr}</span>
                  </div>
                </div>
                <div>
                  <label className="text-[12px] text-zinc-500 mb-1.5 block">Phone</label>
                  <input type="text" value={phone} onChange={e => setPhone(e.target.value)}
                    className="w-full px-4 py-2.5 bg-white border border-zinc-200 rounded-lg text-[14px] text-zinc-900 outline-none focus:ring-2 focus:ring-zinc-900/10" />
                </div>
                <div>
                  <label className="text-[12px] text-zinc-500 mb-1.5 block">Job Title</label>
            ...
            <div className="glass-card rounded-2xl overflow-hidden">
              ...
              <div className="p-6 grid grid-cols-2 gap-5">
                <div>
                  <label className="text-[12px] text-zinc-500 mb-1.5 block">Timezone</label>
                ...
                <div>
                  <label className="text-[12px] text-zinc-500 mb-1.5 block">Language</label>
            ...
            <div className="glass-card rounded-2xl p-6">
              ...
              <div className="grid grid-cols-3 gap-6 mt-4">
                <div>
                  ...
                  <p className="text-[14px] text-zinc-900 mt-1">Admin</p>
                </div>
                <div>
                  <p className="text-[12px] text-zinc-500">Member Since</p>
                  <p className="text-[14px] text-zinc-900 mt-1">January 15, 2024</p>
                </div>
                <div>
                  <p className="text-[12px] text-zinc-500">Last Password Change</p>
                  <p className="text-[14px] text-zinc-900 mt-1">February 28, 2026</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="glass-card rounded-2xl p-6">
              <div className="flex items-start justify-between">
                <div>
                  ...
                  <p className="text-[13px] text-zinc-400 mt-1">Last changed on February 28, 2026. Expires in 45 days.</p>
                </div>
                <button className="px-4 py-2 border border-zinc-300 text-zinc-700 rounded-lg hover:bg-zinc-100 transition-colors text-[13px]">
                  Change Password
                </button>
              </div>
            </div>
            ...
            <div className="glass-card rounded-2xl p-6">
              <div className="flex items-start justify-between">
                <div>
                  ...
                  <p className="text-[13px] text-zinc-400 mt-1">MFA is enabled via Authenticator App. Configured on January 15, 2024.</p>
                  <div className="flex items-center gap-2 mt-2">
                    <span className="text-[11px] px-2 py-0.5 rounded-full bg-emerald-100 text-emerald-800 flex items-center gap-1"><Checkmark size={12} /> Active</span>
            ...
            <div className="glass-card rounded-2xl p-6">
              ...
              <div className="space-y-2">
                {[
                  ...
                  <div key={i} className="flex items-center justify-between px-4 py-2.5 bg-zinc-50 rounded-lg">
                    <div className="flex items-center gap-3">
                      <span className="font-mono text-[12px] text-zinc-500 w-36">{entry.time}</span>
                      <span className="text-[13px] text-zinc-700">{entry.device}</span>
                    </div>
                    <div className="flex items-center gap-3">
                      <span className="text-[12px] text-zinc-400 flex items-center gap-1"><Location size={12} />{entry.location}</span>
                      <span className={`text-[11px] px-2 py-0.5 rounded-full ${entry.status === 'Success' ? 'bg-emerald-100 text-emerald-800' : 'bg-red-100 text-red-800'}`}>
                        {entry.status}
                      </span>
                    </div>
                  </div>
          ...
          <div className="space-y-3">
                ...
                <div className="flex items-start justify-between gap-4">
                  <div className="flex items-start gap-3">
                    <div className="w-10 h-10 bg-zinc-100 rounded-lg flex items-center justify-center shrink-0">
                      <Devices size={18} className="text-zinc-500" />
                    </div>
                    <div>
                      <div className="flex items-center gap-2">
                        <p className="text-[14px] text-zinc-900">{session.device}</p>
                        {session.isCurrent && <span className="text-[10px] px-2 py-0.5 rounded-full bg-emerald-100 text-emerald-800">Current</span>}
                      </div>
                      <p className="text-[13px] text-zinc-500 mt-0.5">{session.browser}</p>
                      <div className="flex gap-4 mt-1.5 text-[12px] text-zinc-400">
            ...
            {sessions.length > 1 && (
              <button onClick={() => setSessions(prev => prev.filter(s => s.isCurrent))}
                className="w-full py-3 border border-red-300 text-red-600 rounded-xl hover:bg-red-50 transition-colors text-[13px]">
          ...
          <div className="space-y-2">
            {MOCK_ACTIVITY.map((entry, i) => (
              <div key={i} className="flex items-center gap-4 px-5 py-3 glass-card rounded-lg">
                ...
                <span className="text-[13px] text-zinc-500 flex-1 truncate">{entry.resource}</span>
              </div>
            ))}
          </div>
        )}
